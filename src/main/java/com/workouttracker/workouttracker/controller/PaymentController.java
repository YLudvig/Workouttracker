    ...
    public ResponseEntity<Map<String, String>> createCheckoutSession(@RequestBody Map<String, String> request ){
        try{
            ...
            SessionCreateParams params = SessionCreateParams.builder()
                    ...
                    .setSuccessUrl("https://sea-turtle-app-qgvyw.ondigitalocean.app/api/stripe/payment-success?session_id={CHECKOUT_SESSION_ID}") //Vill byta denna till en mer lämplig i längden, borde göra en success.html
