...
public class PaymentController {
    ...
    public ResponseEntity<Map<String, String>> createCheckoutSession(@RequestBody Map<String, String> request ){
        try{
            ...
            SessionCreateParams params = SessionCreateParams.builder()
                    ...
                    .setSuccessUrl("https://sea-turtle-app-9hnsk.ondigitalocean.app/api/stripe/payment-success?session_id={CHECKOUT_SESSION_ID}") //Vill byta denna till en mer lämplig i längden, borde göra en success.html
                    .setCancelUrl("https://sea-lion-app-9hnsk.ondigitalocean.app") //Vill byta denna till en mer lämplig i längden, borde göra en cancel.html
                    .addLineItem(
    ...
    public ResponseEntity<String> handlePaymentSuccess(@RequestParam("session_id") String sessionId) {
        try {
            ...
            return ResponseEntity.status(302).header("Location", "https://sea-lion-app-9hnsk.ondigitalocean.app").build();
